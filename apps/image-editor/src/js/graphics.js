...
import EraseDrawing from '@/component/eraseDrawing';
...
import EraseDrawingMode from '@/drawingMode/eraseDrawing';
...
class Graphics {
  ...
  _createComponents() {
    ...
    this._register(this._componentMap, new EraseDrawing(this));
